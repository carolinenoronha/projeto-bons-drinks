...
class Team extends Component {
    render(){
        return(
            ...
            <img className="timeImg fotopessoa1" src="https://www.condemais.com.br/wp/wp-content/uploads/2019/01/C87A0981perfil.jpg"></img>
            ...
            <img className="timeImg fotopessoa3" src="https://s2.glbimg.com/OTqXaX_rl0izkov4PQF-QOGH4dQ=/0x0:1883x2824/984x0/smart/filters:strip_icc()/i.s3.glbimg.com/v1/AUTH_e84042ef78cb4708aeebdf1c68c6cbd6/internal_photos/bs/2020/P/z/XMRfTCS9ActgiJt359Qg/sophie-charlotte-e-maria-alice-na-serie-todas-as-mulheres-do-mundo.jpg"></img>
            ...
            <img className="timeImg fotopessoa4" src="https://nedjornal.files.wordpress.com/2020/05/laura-martha-nowill-.jpg?w=600"></img>
